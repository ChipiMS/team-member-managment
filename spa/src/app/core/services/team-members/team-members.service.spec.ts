...
describe('TeamMembersService', () => {
  ...
  it('should create team member', () => {
    ...
    service.createTeamMember(newMember as TeamMember).subscribe((member: TeamMember) => {
  ...
  it('should update team member', () => {
    ...
    service.updateTeamMember(memberId, updatedMember).subscribe((member: TeamMember) => {
      expect(member).toEqual({ ...mockTeamMembers[0], ...updatedMember });
    });

    const req = httpMock.expectOne(`${environment.apiUrl}/team-members/${memberId}/`);
